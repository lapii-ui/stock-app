...
(function (factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__WEBPACK_LOCAL_MODULE_0__], __WEBPACK_AMD_DEFINE_RESULT__ = (function ($) {
      return factory($);
    }).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
    ...
    */
    ...
    function onReset(event, instance) {
      ...
      if (instance && instance.isModal()) {
        ...
        var lastResetElement = target === instance.elements.reset[1] || instance.__internal.buttons.length === 0 && target === document.body; // if last reset link, then go to maximize or close
    ...
    function bindEvents(instance) {
      ...
      on(instance.elements.reset[1], 'focus', instance.__internal.resetHandler); //prevent handling key up when dialog is being opened by a key stroke.
    ...
    function unbindEvents(instance) {
      ...
      off(instance.elements.reset[1], 'focus', instance.__internal.resetHandler); // hook out transition handler
...
/***/ 1:
/*!*********************************************!*\
  !*** multi ./resources/js/common/jquery.js ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\wamp64\www\stock-app\resources\js\common\jquery.js */"./resources/js/common/jquery.js");
